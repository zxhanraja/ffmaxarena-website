...
export const LoginBotIcon: React.FC<IconProps & { isAwake?: boolean }> = ({ isAwake = true, ...props }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
            ...
            <g className="bot-eyes-open" style={{ opacity: isAwake ? 1 : 0 }}>
                <circle cx="10" cy="12" r="1.2" fill="currentColor"/>
                <circle cx="14" cy="12" r="1.2" fill="currentColor"/>
            </g>
            
            {/* Eyes closed (sleeping) */}
            <g className="bot-eyes-closed" style={{ opacity: isAwake ? 0 : 1 }}>
                <path d="M9 12.5 h 2.5" />
                <path d="M13.5 12.5 h 2.5" />
            </g>
        </svg>
    );
};
...
export const TelegramIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" height="24" width="24" {...props}>
        <path d="M9.78 18.65l.28-4.23 7.68-6.92c.34-.31-.07-.46-.52-.19L7.74 13.3 3.64 12c-.88-.25-.89-1.37.2-1.72l16.13-5.73c.73-.27 1.36.17 1.15.99l-2.28 10.57c-.23.95-1.05 1.17-1.78.73l-4.52-3.33-2.13 2.05c-.23.23-.42.42-.8.42z" />
    </svg>
);
